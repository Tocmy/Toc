...
class AttributeGroupDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('checkbox', function($attribute){
                ...
                <input type="checkbox" class="" data-id="'.$attribute->attribute_id.'" name="id[]" value="'.$attribute->attribute_id.'">
            ...
            ->addColumn('action', function($attribute){
                $action = '<div class="btn-group dropdown">
                  ...
                  <a href="'.route('admin.suppliers.edit', [$attribute->id]).'" class="dropdown-item">
                  <i class="las la-pen-nib" aria-hidden="true"></i>
                  '.__('Edit').'
                  </a>
                  <a href="'.route('admin.suppliers.destroy', [$attribute->id]).'" class="dropdown-item">
     ...
     *
     * @param \App\Models\Attribute\AttributeGroup $model
    ...
    {
        return $this->builder()
                    ->setTableId('attribute\attributegroupdatatable-table')
    ...
    {
        return 'Attribute\AttributeGroup_' . date('YmdHis');
    }
}
