...
class RoleDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('checkbox', function($role){
                ...
                <input type="checkbox" class="" data-id="'.$role->role_id.'" name="id[]" value="'.$role->role_id.'">
            ...
            ->addColumn('action', function($role){
                $action = '<div class="btn-group dropdown">
                  ...
                  <a href="'.route('admin.suppliers.edit', [$role->id]).'" class="dropdown-item">
                  <i class="las la-pen-nib" aria-hidden="true"></i>
                  '.__('Edit').'
                  </a>
                  <a href="'.route('admin.suppliers.destroy', [$role->id]).'" class="dropdown-item">
     ...
     *
     * @param \App\Models\User\Role $model
    ...
    {
        return $this->builder()
                    ->setTableId('user\roledatatable-table')
