    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">{{ __('Add banner Group') }}</div>
                <div class="card-tools">
                    {!! Form::open()->post()->multipart()->route('bannergroup.store') !!}
                    ...
                    'title' => '{{__('Cancel')}}' 'route' => 'bannergroup.index' ],<i class="mdi mdi-close-thick"></i>) !!}
                </div>
            </div>
            <div class="card-body">

                @include('admin.bannergroup.form')
                {!! Form::close() !!}
            </div>
        </div>
    </div>
