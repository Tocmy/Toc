 ...
 <div class="row">
     <div class="col-sm-12">
       ...
       <div class="card-header">
          <div class="card-title"> {{ __('Currency Class Management') }}</div>

                <div class="card-tools">

                    <a href="{{ route('currencies.create') }}" type="button" class="btn btn-circle btn-info" data-toggle="tooltip" title="{{ __('Add') }}" data-placement="top">
