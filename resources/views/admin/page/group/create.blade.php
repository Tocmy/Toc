    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">{{ __('Add Page Group') }}</div>
                <div class="card-tools">
                    {!! Form::open()->post()->multipart()->route('pagegroups.store') !!}
                    ...
                    'title' => '{{__('Cancel')}}' 'route' => 'pagegroups.index' ],<i class="mdi mdi-close-thick"></i>) !!}
                </div>
            </div>
            <div class="card-body">

                @include('admin.page.group.form')
                {!! Form::close() !!}
            </div>
        </div>
    </div>
