 ...
 <div class="row">
     <div class="col-sm-12">
       ...
       <div class="card-header">
          <div class="card-title"> {{ __('Product Management') }}</div>

                <div class="card-tools">

                    <a href="{{ route('products.create') }}" type="button" class="btn btn-circle btn-info" data-toggle="tooltip" title="{{ __('Add') }}" data-placement="top">
