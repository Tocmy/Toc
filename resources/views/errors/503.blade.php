    ...
    <div class="row error">
        <div class="col-lg-12 ground-color text-center">
           <div class="container-error">
             ...
             <h2 class="h1">__('Under Maintenance')</h2>
             <p class="message">__('We sincerely apologize for the inconvenience. Our site is currently under scheduled maintenance and upgrades, but will return shortly. Thank you for your patience.')</p>
        </div>
    </div>
</div>
